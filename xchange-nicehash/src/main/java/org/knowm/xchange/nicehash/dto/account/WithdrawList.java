...
public final class WithdrawList extends WapiResponse<List<NicehashWithdraw>> {
  ...
  private final NicehashWithdraw[] withdrawList;

  public WithdrawList(
      @JsonProperty("withdrawList") NicehashWithdraw[] withdrawList,
  ...
  @Override
  public List<NicehashWithdraw> getData() {
  ...
  public static final class NicehashWithdraw {
    /*
    {
             "amount":30.00000000,
    ...
    @Override
    public String toString() {
      return "NicehashWithdraw [amount="
          + amount
          + ", address="
          + address
          + ", successTime="
